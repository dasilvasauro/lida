...
export interface Task {
  ...
  subtasks?: SubTask[]; createdAt: number; deadlineDate?: string;
...
export interface Vision { traitsToDevelop: string[]; traitsToAbandon: string[]; goals: BigGoal[]; checkpoints: string[]; createdAt: number; }
export type ReflectionColor = ItemColor;
export interface Reflection { id: string; title: string; color: ReflectionColor; cards: string[]; createdAt: number; }
